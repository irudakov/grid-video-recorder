package io.nirvagi.node.task.config;

/**
 * This is a complete copy of the corresponding class from SeleniumGridExtras repo. Adaptation is required
 * we could strip out a lot
 * */
